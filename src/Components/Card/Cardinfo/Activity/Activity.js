...
import DescriptionInitialBox from "../CardDescription/DescriptionInitialBox";

export default function Activity() {


    const [name,setName]=useState(  JSON.parse(localStorage.getItem("prac")) || '')
...
setName(e.target.value)
  ...
  useEffect(() => {
    localStorage.setItem("prac", JSON.stringify(name));
  }, [name]);
  return (
